...
public final class CommentFeed extends com.google.api.client.json.GenericJson {
   ...
   */
  public CommentFeed setEtag(String etag) {
    this.etag = etag;
    return this;
  }
   ...
   */
  public CommentFeed setId(String id) {
    this.id = id;
    return this;
  }
   ...
   */
  public CommentFeed setKind(String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public CommentFeed setNextLink(String nextLink) {
   ...
   */
  public CommentFeed setNextPageToken(String nextPageToken) {
   ...
   */
  public CommentFeed setTitle(String title) {
    this.title = title;
    return this;
  }
